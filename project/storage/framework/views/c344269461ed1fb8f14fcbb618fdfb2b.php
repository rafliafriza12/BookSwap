    ...
    <div class=" w-full h-[8%] bg-[#212121] flex items-center rounded-xl px-4 gap-5">
        ...
        <div class=" flex items-center gap-3">
            <div class=" w-[35px] h-[35px] overflow-hidden">
                <img src="<?php echo e(asset(url(''.$receiver->image_path))); ?>" alt="" class=" w-full h-full object-cover rounded-full">
            </div>
            <h1 class=" text-[#b3b3b3] font-bold text-xl"><?php echo e($receiver->name); ?></h1>
        </div>
    </div>
    <form action="/send-message/<?php echo e($receiver->id); ?>" method="POST" class="w-full h-[90%] flex flex-col justify-between">
        <?php echo csrf_field(); ?>
        <div id="all-chats-container" class=" w-full h-[90%] flex py-4 px-5 flex-col gap-5 overflow-x-hidden scrollbar-thumb-rounded-full scrollbar-track-rounded-full scrollbar-thin scrollbar-thumb-[#b3b3b3] rounded-lg">
            ...
            <?php $__currentLoopData = $chats; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $chat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <div class=" w-full flex justify-end gap-5 items-center">
                    <p class=" whitespace-pre-line py-1 px-5 max-w-[40%] bg-[#212121] text-[#b3b3b3] font-medium rounded-lg duration-200 hover:bg-[#1db954] hover:text-[#212121]"><?php echo e($chat->message); ?></p>
                    <div class=" w-[25px] h-[25px] overflow-hidden">
                        <img src="<?php echo e(asset(url(''.auth()->user()->image_path))); ?>" alt="" class=" w-full h-full object-cover rounded-full">
                    </div>
                </div>
                <?php else: ?>
...
</html><?php /**PATH /home/whoami/Joki/BookSwap/project/resources/views/pages/chat.blade.php ENDPATH**/ ?>