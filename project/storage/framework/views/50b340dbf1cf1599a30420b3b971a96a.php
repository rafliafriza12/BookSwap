        ...
        <a href="/selected-book/<?php echo e($book->id); ?>" class="">
            ...
            <div class="px-5 pb-5 pt-5 flex flex-col gap-2">
                ...
                <div class=" w-full flex justify-end items-center gap-3 font-semibold">
                    <a href="/edit-buku/<?php echo e($book->id); ?>" class="text-[#212121] rounded-2xl bg-[#b3b3b3] py-1 px-6 hover:bg-[#1db954] duration-300">Edit</a>
                    <button id="delete-<?php echo e($book->id); ?>" onclick="deleteMyBook('<?php echo e($book->id); ?>')" class="text-[#212121] bg-[#b3b3b3] py-1 px-4 rounded-2xl hover:bg-red-500 duration-300">Hapus</button>
                </div>
            </div>
        </a>
        <div id="crud-modal-delete-<?php echo e($book->id); ?>" tabindex="-1" aria-hidden="true"
            ...
            <div class="relative p-4 w-full max-w-md max-h-full">
                ...
                <div class="relative bg-[#212121] rounded-lg shadow border border-white">
                    ...
                    <div
                        ...
                        <button type="button" id="close-modal-delete-<?php echo e($book->id); ?>"
                    ...
                    <!-- Modal body -->
                    <div class="py-5 px-5">
                        <form action="/hapus-buku/<?php echo e($book->id); ?>" method="POST">
                            <?php echo csrf_field(); ?>
...
</div><?php /**PATH /home/whoami/Joki/BookSwap/project/resources/views/components/bukusaya.blade.php ENDPATH**/ ?>