    ...
    <div class=" w-screen h-screen overflow-hidden flex flex-col justify-center items-center relative bg-[#121212] font-poppins text-white">
        <form class=" w-[35%] py-8 px-10 bg-[#212121] flex flex-col items-center rounded-lg gap-9" method="POST" action="/signup/register">
            ...
            <div class=" w-full flex flex-col gap-7 font-meduim">
                <input value="<?php echo e(old('name')); ?>" placeholder="Fullname"name="name" type="text" class=" w-full h-10 rounded-lg bg-[#535353] focus:outline-none focus:border-[2px] focus:border-[#fff] px-3 placeholder:text-[#b3b3b3]" required>
...
</html><?php /**PATH /home/whoami/Joki/BookSwap/project/resources/views/pages/signup.blade.php ENDPATH**/ ?>