<?php $__env->startSection('title', 'Selected Book'); ?>
...
<div class=" w-full flex justify-center items-center px-48 pb-11 box-border">
    <div class=" w-full bg-[#212121] rounded-2xl flex py-20 items-center">
        <div class=" w-[40%] h-[450px] p-7">
            <img src="<?php echo e(asset(url(''.$book->image_path))); ?>" alt=""
        ...
        <div class=" w-[60%] py-7 px-24 flex flex-col gap-6 justify-center items-center text-[#b3b3b3]">
            ...
            <div class=" w-full flex items-center justify-between gap-3">
                <div class="w-full flex gap-5 items-center">
                    <div class=" w-[40px] h-[40px] overflow-hidden rounded-full">
                        <img src="<?php echo e(asset(url(''.$user->image_path))); ?>" alt="" class=" w-full h-full object-cover">
                    </div>
                    <h1 class=" text-lg font-semibold"><?php echo e($user->name); ?></h1>
                </div>
                <div>
                    <a href="/chat/<?php echo e($user->id); ?>" class=" py-1 px-6 bg-[#b3b3b3] text-[#121212] rounded-3xl font-semibold hover:bg-[#1db954] hover:text-white duration-200">Chat</a>
                </div>
            </div>
            <?php endif; ?>
            <div action="" enctype="multipart/form-data"
                ...
                <div class=" w-full py-2 border-b border-[#b3b3b3] px-3">
                    <h1 class="w-full bg-transparent text-xl font-bold"><?php echo e($book->judul); ?></h1>
                </div>
                <div class=" w-full py-2 border-b border-[#b3b3b3] px-3">
                    <h1  class="w-full bg-transparent font-medium"><?php echo e($book->deskripsi); ?></h1>
                </div>
                <div class=" w-full py-2 border-b border-[#b3b3b3] px-3">
                    <h1  class="w-full bg-transparent font-medium"><?php echo e($book->kategori); ?></h1>
                </div>
                <div class=" w-full py-2 border-b border-[#b3b3b3] px-3">
    ...
    <div id="crud-modal-borrow" tabindex="-1" aria-hidden="true"
        ...
        <div class="relative p-4 w-full max-w-md max-h-full">
            ...
            <div class="relative bg-[#212121] rounded-lg shadow border border-white">
                ...
                <form method="POST" action="/pinjam/<?php echo e($book->id); ?>" class=" w-full px-5 py-2 flex flex-col gap-2">
                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/whoami/Joki/BookSwap/project/resources/views/pages/selectedbook.blade.php ENDPATH**/ ?>